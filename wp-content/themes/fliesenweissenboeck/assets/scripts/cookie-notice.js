...
cookie_name: 'fliesen_weissenboeck_cookie', // Name des Cookies, der zur Speicherung der Entscheidung verwendet wird
...
cookie_groups: [
	 {
		...
		info: 'Zum Betrieb der Seite notwendige Cookies:',
			cookies: [
					...
					name: 'fliesen_weissenboeck_cookie',
					duration: '1 Jahr'
				}
			],
		...
		cookies: [
				...
				accept: function() {
					...
					el.src = 'https://www.googletagmanager.com/gtag/js?id=UA-61538743-2';
					el.async = 1;
					...
					gtag('config', 'UA-61538743-2', { 'anonymize_ip': true });
				...
				reject: function() {
					...
					window['ga-disable-UA-61538743-2'] = true;
					window.dataLayer = window.dataLayer || [];

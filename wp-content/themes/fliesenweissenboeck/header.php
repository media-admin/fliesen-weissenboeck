			...
			<section class="branding">
			    ...
			    <div class="container">
			    	...
			    	<h1 class="title">
				  	...
				  	<a href="<?php echo get_home_url(); ?>"><img class="brand-logo brand-logo--mobile" src="<?php bloginfo('template_directory'); ?>/img/fliesen-weissenboeck-logo-hoch.svg" alt="Logo Fliesen Weißenböck (Hochformat)"></a>
				  	<a href="<?php echo get_home_url(); ?>"><img class="brand-logo brand-logo--desktop" src="<?php bloginfo('template_directory'); ?>/img/fliesen-weissenboeck-logo-quer.svg" alt="Logo Fliesen Weißenböck (Querformat)"></a>

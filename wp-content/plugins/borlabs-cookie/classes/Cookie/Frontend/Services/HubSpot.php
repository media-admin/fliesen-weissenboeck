...
class HubSpot
{
    ...
    public function additionalSettingsTemplate($data)
    {
        ...
        <div class="form-group row">
            <label for="hubId"
                   class="col-sm-4 col-form-label"><?php _ex('Hub id', 'Backend / Cookie / HubSpot / Label', 'borlabs-cookie'); ?></label>
            <div class="col-sm-8">
                <input type="text" class="form-control form-control-sm d-inline-block w-75 mr-2" id="hubId"
                       name="settings[hubId]" value="<?php echo $inputHubId; ?>"
                       placeholder="<?php _ex('Example', 'Backend / Global / Input Placeholder', 'borlabs-cookie'); ?>: 1234567"
                       required>
                <span data-toggle="tooltip"
                      title="<?php _ex('Enter your Hub id.', 'Backend / Cookie / HubSpot / Tooltip', 'borlabs-cookie'); ?>"><i

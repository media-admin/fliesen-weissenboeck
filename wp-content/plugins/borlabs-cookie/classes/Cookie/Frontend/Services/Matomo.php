...
class Matomo
{
    ...
    public function additionalSettingsTemplate($data)
    {
        ...
        <div class="form-group row">
            <label for="matomoUrl"
                   class="col-sm-4 col-form-label"><?php _ex('Matomo URL', 'Backend / Cookie / Matomo / Label', 'borlabs-cookie'); ?></label>
            <div class="col-sm-8">
                ...
                <span data-toggle="tooltip"
                      title="<?php _ex('Enter the URL of your Matomo installation.', 'Backend / Cookie / Matomo / Tooltip', 'borlabs-cookie'); ?>"><i
        ...
        <div class="form-group row">
            <label for="matomoSiteId"
                   class="col-sm-4 col-form-label"><?php _ex('Matomo Site ID', 'Backend / Cookie / Matomo / Label', 'borlabs-cookie'); ?></label>
            <div class="col-sm-8">
                <input type="text" class="form-control form-control-sm d-inline-block w-75 mr-2" id="matomoSiteId"
                       name="settings[matomoSiteId]" value="<?php echo $inputMatomoSiteId; ?>"
                       placeholder="<?php _ex('Example', 'Backend / Global / Input Placeholder', 'borlabs-cookie'); ?>: 1"
                       required>
                <span data-toggle="tooltip"
                      title="<?php _ex('Enter the <strong>Site ID</strong> of the website from Matomo.', 'Backend / Cookie / Matomo / Tooltip', 'borlabs-cookie'); ?>"><i
                        class="fas fa-lg fa-question-circle text-dark"></i></span>
                <div
                    class="invalid-feedback"><?php _ex('This is a required field and cannot be empty.', 'Backend / Global / Validation Message', 'borlabs-cookie'); ?></div>
            </div>
